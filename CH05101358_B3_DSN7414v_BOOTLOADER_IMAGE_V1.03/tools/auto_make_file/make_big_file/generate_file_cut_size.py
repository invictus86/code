...
copyfile_to_folder("big_see_size.ubo", "../big_see_size.ubo")
copyfile_to_folder("big_vmlinux_size.bin", "../big_vmlinux_size.bin")
copyfile_to_folder("big_cfg_size.squashfs", "../big_cfg_size.squashfs")

copyfile_to_folder("excessive_big_bootlogo_size.bin", "../excessive_big_bootlogo_size.bin")
copyfile_to_folder("excessive_big_fsi_size.bin", "../excessive_big_fsi_size.bin")
copyfile_to_folder("excessive_big_see_size.ubo", "../excessive_big_see_size.ubo")
copyfile_to_folder("excessive_big_vmlinux_size.bin", "../excessive_big_vmlinux_size.bin")
copyfile_to_folder("excessive_big_cfg_size.squashfs", "../excessive_big_cfg_size.squashfs")
