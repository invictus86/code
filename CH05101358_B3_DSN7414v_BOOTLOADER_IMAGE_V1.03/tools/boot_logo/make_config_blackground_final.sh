...
./Makebootlogo ekt_logo_black.m2v  1001  font Pic_font.gz     strT StringTable-be2.bin    ftco font_color_black_ground    pbhi progressbarheight    prcc black_progress_circle.gz
./AddMac bootlogo.bin
#font  Pic_font